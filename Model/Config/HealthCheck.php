...
namespace ZipMoney\ZipMoneyPayment\Model\Config;
...
class HealthCheck
{
     ...
     * @param \ZipMoney\ZipMoneyPayment\Helper\Logger $logger
     * @param \ZipMoney\ZipMoneyPayment\Helper\Data $helper
     * @param \ZipMoney\ZipMoneyPayment\Model\Config $config
    ...
    public function getHealthResult($websiteId)
    {
        ...
        if (!$curlEnabled) {
            ...
            try {
                ...
                if (($httpCode == 404 || ($httpCode >= 200 && $httpCode <= 299))) {
